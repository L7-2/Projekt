    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" data-spy="affix" data-offset-top="50">
      <div class="container">
        ...
        <div class="navbar-header col-md-3">
          ...
          <a class="navbar-brand" href="#home"><i class="fa fa-briefcase"></i> Ankiety</a>
        </div>

        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="nav navbar-nav col-md-9 pull-right">
                            <li class="active"><a href="#hero-area"><i class="fa fa-home"></i> Strona główna</a></li>
                            <li><a href="#services"><i class="fa fa-cogs"></i> Stwórz ankietę</a></li>
                            
                           
                            <li><a href="#about"><i class="fa fa-info"></i> O nas</a></li>
...
<div class="container">
    <div class="row">
<div class="col-md-12">
        <h1 class="title">Ankiety Online</h1>
        <h2 class="subtitle">Prosto i przejrzyście</h2>

        <img class="col-md-6 col-sm-6 col-xs-12 animated fadeInLeft" src="assets/img/hero/Poll_votebox-1024x768.jpg" alt="">
...
<div class="row">
<h1 class="title">Stwórz własną ankietę</h1>
...
<!-- Conatct Section End-->
    ...
    <div id="copyright">
    <div class="container">
    <div class="col-md-10"><p>©Maciek</a></p></div>
    <div class="col-md-2">
